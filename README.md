...
Any habit, whatever its frequency, can also carry an optional **time of day** (`time: "21:00"` in frontmatter, a time picker in the modal). It is purely informational — shown on the habit's card next to the schedule (e.g. "Every other day · 9:00 PM") — and never affects when a habit is due.
